...
class Stock_Market_Dynamics_Emulator {
  constructor(size_tuple, p_d, p_h, p_c) {
    ...
    // Generating a Grid of 0's of the Given Dimensions
    this.config = [];
    ...
    // Getting the Random Initial Configuration of the Grid
